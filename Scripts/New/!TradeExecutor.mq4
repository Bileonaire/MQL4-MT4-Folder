...
input e_orderType  orderType = SellStop;

extern double Account = 0;
extern double Percentage_Risk = 0;

extern double  totalLot = 2.6;
...
input e_print_lot  print_lot = la;

extern int numOfOrders = 15;
extern string comment = "u";
...
extern string consider= "Hey!!! USA Elections Signal --- ";
